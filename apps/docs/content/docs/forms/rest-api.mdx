...
description: Endpoints, authentication and error codes for the packrelay/v1 namespace.
---

import { Callout } from "fumadocs-ui/components/callout";

Namespace: `packrelay/v1`. Base URL: `https://your-site.example/wp-json/packrelay/v1`.
...
`packrelay_appcheck_verified` fires after a token verifies, with the app ID, form ID and token —
useful for auditing.

```php
add_action( 'packrelay_appcheck_verified', function ( $app_id, $form_id, $token ) {
