...
class Test_MRDW_Push_DB extends MRDW_Push_TestCase {
	...
	public function test_insert_device_returns_id() {
		...
		$result = MRDW_Push_DB::insert_device( array(
	...
	public function test_remove_device() {
		...
		$result = MRDW_Push_DB::remove_device( 'ExponentPushToken[test]' );
	...
	public function test_delete_device() {
		...
		$result = MRDW_Push_DB::delete_device( 1 );
		$this->assertTrue( $result );
	}
	...
	public function test_get_device() {
		...
		$result = MRDW_Push_DB::get_device( 1 );
	...
	public function test_get_device_not_found() {
		...
		$result = MRDW_Push_DB::get_device( 999 );
	...
	public function test_get_device_by_token() {
		...
		$result = MRDW_Push_DB::get_device_by_token( 'ExponentPushToken[xyz]' );
	...
	public function test_get_device_by_token_not_found() {
		...
		$result = MRDW_Push_DB::get_device_by_token( 'ExponentPushToken[nope]' );
		$this->assertNull( $result );
	}
	...
	public function test_update_device() {
		...
		$result = MRDW_Push_DB::update_device( 10, array( 'user_label' => 'My Phone' ) );
		$this->assertTrue( $result );
	}
	...
	public function test_update_device_failure() {
		...
		$result = MRDW_Push_DB::update_device( 999, array( 'user_label' => 'Nope' ) );
		$this->assertFalse( $result );
	}
	...
	public function test_get_tokens_by_target_dev() {
		...
		$tokens = MRDW_Push_DB::get_tokens_by_target( 'dev' );
		$this->assertCount( 1, $tokens );
	}
	...
	public function test_get_tokens_by_target_empty_group() {
		$tokens = MRDW_Push_DB::get_tokens_by_target( 'group', array() );
	...
	public function test_get_tokens_by_target_empty_specific() {
		$tokens = MRDW_Push_DB::get_tokens_by_target( 'specific', array() );
		$this->assertEmpty( $tokens );
	}
	...
	public function test_get_devices() {
		...
		$result = MRDW_Push_DB::get_devices();
	...
	public function test_get_devices_with_filters() {
		...
		$result = MRDW_Push_DB::get_devices( array(
			'device_type' => 'ios',
			'is_active'   => 1,
			'search'      => 'search',
		) );
	...
	public function test_get_device_count_active() {
		...
		$result = MRDW_Push_DB::get_device_count( true );
	...
	public function test_get_device_count_all() {
		...
		$result = MRDW_Push_DB::get_device_count( false );
	...
	public function test_get_device_count_by_platform() {
		...
		$result = MRDW_Push_DB::get_device_count_by_platform();
	...
	public function test_get_dev_device_count() {
		...
		$result = MRDW_Push_DB::get_dev_device_count();
	...
	public function test_bulk_delete_devices() {
		...
		$count = MRDW_Push_DB::bulk_delete_devices( array( 1, 2 ) );
	...
	public function test_create_group() {
		...
		$result = MRDW_Push_DB::create_group( array(
			'name'        => 'Test Group',
	...
	public function test_delete_group() {
		...
		$result = MRDW_Push_DB::delete_group( 1 );
		$this->assertTrue( $result );
	}
	...
	public function test_insert_notification() {
		...
		$result = MRDW_Push_DB::insert_notification( array(
			'title' => 'Test',
			'body'  => 'Test body',
			'type'  => 'manual',
		) );
	...
	public function test_update_notification() {
		...
		$result = MRDW_Push_DB::update_notification( 10, array( 'status' => 'sent' ) );
		$this->assertTrue( $result );
	}
	...
	public function test_get_notification() {
		...
		$result = MRDW_Push_DB::get_notification( 10 );
	...
	public function test_get_notification_not_found() {
		...
		$result = MRDW_Push_DB::get_notification( 999 );
		$this->assertNull( $result );
	}
	...
	public function test_get_notifications() {
		...
		$result = MRDW_Push_DB::get_notifications();
	...
	public function test_get_notifications_with_type_filter() {
		...
		$result = MRDW_Push_DB::get_notifications( array( 'type' => 'manual', 'status' => 'sent' ) );
	...
	public function test_get_recent_notifications() {
		...
		$result = MRDW_Push_DB::get_recent_notifications( 5 );
	...
	public function test_get_scheduled_notifications() {
		...
		$result = MRDW_Push_DB::get_scheduled_notifications();
		$this->assertCount( 1, $result );
	...
	public function test_get_pending_receipt_notifications() {
		...
		$result = MRDW_Push_DB::get_pending_receipt_notifications();
		$this->assertCount( 1, $result );
	}
	...
	public function test_get_notification_counts_by_status() {
		...
		$result = MRDW_Push_DB::get_notification_counts_by_status();
	...
	public function test_get_monthly_send_count() {
		...
		$result = MRDW_Push_DB::get_monthly_send_count();
		$this->assertSame( 42, $result );
	}
	...
	public function test_get_success_rate() {
		...
		$result = MRDW_Push_DB::get_success_rate();
	...
	public function test_insert_notification_history() {
		...
		$result = MRDW_Push_DB::insert_notification_history( 42, 10 );
	...
	public function test_get_post_notification_history() {
		...
		$result = MRDW_Push_DB::get_post_notification_history( 42 );
	...
	public function test_get_devices_for_export() {
		...
		$result = MRDW_Push_DB::get_devices_for_export();
		$this->assertCount( 2, $result );
	}
	...
	public function test_import_devices_new() {
		...
		$result = MRDW_Push_DB::import_devices( $rows );
	...
	public function test_deactivate_tokens() {
		...
		$count = MRDW_Push_DB::deactivate_tokens( array(
	...
	public function test_get_device_summary_stats_cached() {
		...
		Functions\when( 'get_transient' )->alias( function( $key ) use ( $cached ) {
			if ( 'mrdw_push_device_summary_stats' === $key ) {
				return $cached;
			}
			return false;
		} );

		$result = MRDW_Push_DB::get_device_summary_stats();
	...
	public function test_invalidate_device_cache() {
		...
		MRDW_Push_DB::invalidate_device_cache();
	...
	public function test_invalidate_notification_cache() {
		// Default stubs handle delete_transient. Just verify no errors.
		MRDW_Push_DB::invalidate_notification_cache();
		$this->assertTrue( true );
	}
