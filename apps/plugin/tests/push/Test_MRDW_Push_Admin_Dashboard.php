<?php
/**
 * Tests for MRDW_Push_Admin_Dashboard.
 *
 * @package MrDemonWolf
 */
...
class Test_MRDW_Push_Admin_Dashboard extends MRDW_Push_TestCase {
	...
	public function test_render_localizes_chart_data() {
		...
		$this->assertSame( 'mrdw-push-admin', $localized[0] );
		$this->assertSame( 'mrdw_push_chart', $localized[1] );
	}
