<?php
/**
 * Tests for MRDW_Push_Admin_Devices AJAX handlers.
 *
 * @package MrDemonWolf
 */
...
class Test_MRDW_Push_Admin_Devices extends MRDW_Push_TestCase {
	...
	public function test_update_device_correct_db_args() {
		...
		$this->assertSame( 'wp_mrdw_push_devices', $update_args[0] );
