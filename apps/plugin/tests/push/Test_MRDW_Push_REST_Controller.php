<?php
/**
 * Tests for MRDW_Push_REST_Controller.
 *
 * @package MrDemonWolf
 */
...
class Test_MRDW_Push_REST_Controller extends MRDW_Push_TestCase {
	...
	public function test_send_notification_no_devices() {
		...
		$this->assertInstanceOf( 'WP_Error', $response );
		$this->assertSame( 'mrdw_push_no_devices', $response->get_error_code() );
	}
	...
	public function test_send_notification_schedule_failure() {
		...
		$this->assertInstanceOf( 'WP_Error', $response );
		$this->assertSame( 'mrdw_push_schedule_failed', $response->get_error_code() );
	}
	...
	public function test_export_devices() {
		...
		$this->assertStringContainsString( 'mrdw-push-devices-', $headers['Content-Disposition'] );
	...
	public function test_import_devices_no_file() {
		...
		$this->assertInstanceOf( 'WP_Error', $response );
		$this->assertSame( 'mrdw_push_no_file', $response->get_error_code() );
	}
	...
	public function test_import_devices_rejects_non_csv() {
		...
		$this->assertInstanceOf( 'WP_Error', $response );
		$this->assertSame( 'mrdw_push_invalid_file_type', $response->get_error_code() );
	}
	...
	public function test_register_device_rate_limited() {
		...
		$this->assertInstanceOf( 'WP_Error', $response );
		$this->assertSame( 'mrdw_push_rate_limited', $response->get_error_code() );
	}
