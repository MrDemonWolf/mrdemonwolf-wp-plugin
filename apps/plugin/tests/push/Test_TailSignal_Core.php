...
require_once dirname( __DIR__, 2 ) . '/modules/push/includes/class-tailsignal-loader.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/includes/class-tailsignal-i18n.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/includes/class-tailsignal-db.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/includes/class-tailsignal-expo.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/includes/class-tailsignal-notification.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/includes/class-tailsignal-cron.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/rest-api/class-tailsignal-rest-controller.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/admin/class-tailsignal-admin.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/admin/class-tailsignal-admin-settings.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/admin/class-tailsignal-admin-send.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/admin/class-tailsignal-admin-groups.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/admin/class-tailsignal-admin-devices.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/admin/class-tailsignal-admin-history.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/admin/class-tailsignal-admin-dashboard.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/admin/class-tailsignal-meta-box.php';
require_once dirname( __DIR__, 2 ) . '/modules/push/includes/class-tailsignal.php';
