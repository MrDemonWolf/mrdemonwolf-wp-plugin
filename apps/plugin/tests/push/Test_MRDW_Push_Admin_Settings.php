<?php
/**
 * Tests for MRDW_Push_Admin_Settings.
 *
 * @package MrDemonWolf
 */
...
class Test_MRDW_Push_Admin_Settings extends MRDW_Push_TestCase {

	/**
	 * @var MRDW_Push_Admin_Settings
	 */
	private $settings;

	protected function setUp(): void {
		parent::setUp();
		$this->settings = new MRDW_Push_Admin_Settings();
	}
	...
	public function test_render_general_section() {
		...
		$this->assertStringContainsString( 'Configure general MRDW_Push settings', $output );
	}
	...
	public function test_render_text_field() {
		...
		$this->assertStringContainsString( 'name="mrdw_push_default_title"', $output );
	...
	public function test_render_toggle_field_checked() {
		...
		$this->assertStringContainsString( 'mrdw_push_dev_mode', $output );
