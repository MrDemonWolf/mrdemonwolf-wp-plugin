...
class Test_MRDW_Push_Admin_Handlers extends MRDW_Push_TestCase {
	...
	public function test_groups_render_passes_with_valid_nonce() {
		...
		Functions\expect( 'wp_verify_nonce' )
			->with( 'valid_nonce', 'mrdw_push_edit_group' )
			->andReturn( true );
	...
	public function test_add_meta_box_multiple_types() {
		Functions\expect( 'apply_filters' )
			->with( 'mrdw_push_post_types', array( 'post' ) )
