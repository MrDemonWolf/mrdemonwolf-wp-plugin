...
// Scratch root for WordPress stubs; must not be the plugin directory, or the
// generated wp-admin stubs end up inside the distributed plugin.
define( 'ABSPATH', sys_get_temp_dir() . '/mrdw-wp-tests/' );
if ( ! is_dir( ABSPATH ) ) {
...
define( 'MRDW_PLUGIN_DIR', __DIR__ . '/../..' . '/' );
...
require_once __DIR__ . '/../..' . '/includes/class-mrdw-modules.php';
require_once __DIR__ . '/../..' . '/includes/class-mrdw-secrets.php';
require_once __DIR__ . '/../..' . '/includes/class-mrdw-conflict.php';
require_once __DIR__ . '/../..' . '/includes/class-mrdw-updater.php';
require_once __DIR__ . '/../..' . '/includes/class-mrdw-admin.php';
