...
/**
 * Class MRDW_Forms_Provider
 *
 * Base class for all form builder providers.
 */
abstract class MRDW_Forms_Provider {
	 ...
	 * allowed by the mrdw_forms_trusted_proxy_headers filter.
	 *
	...
	public function get_client_ip( $request ) {
		 ...
		 */
		$trusted_headers = apply_filters( 'mrdw_forms_trusted_proxy_headers', array( 'X-Forwarded-For' ) );
