...
class PackRelay_Entries_List_Table extends \WP_List_Table {
	...
	public function get_columns() {
		return array(
			...
			'id'           => __( 'ID', 'mrdemonwolf' ),
			'source'       => __( 'Source', 'mrdemonwolf' ),
			'provider'     => __( 'Provider', 'mrdemonwolf' ),
			'form_id'      => __( 'Form ID', 'mrdemonwolf' ),
			'fields'       => __( 'Fields', 'mrdemonwolf' ),
			'ip_address'   => __( 'IP Address', 'mrdemonwolf' ),
			'date_created' => __( 'Date', 'mrdemonwolf' ),
		);
	}
	...
	public function column_id( $item ) {
		...
		$actions = array(
			'view'   => sprintf( '<a href="%s">%s</a>', esc_url( $view_url ), __( 'View', 'mrdemonwolf' ) ),
			'delete' => sprintf( '<a href="%s" onclick="return confirm(\'%s\');">%s</a>', esc_url( $delete_url ), esc_js( __( 'Are you sure?', 'mrdemonwolf' ) ), __( 'Delete', 'mrdemonwolf' ) ),
		);
	...
	public function column_source( $item ) {
		if ( 'divi_frontend' === $item['provider'] ) {
			return '<span class="packrelay-source-badge frontend">' . esc_html__( 'Divi Frontend', 'mrdemonwolf' ) . '</span>';
		}

		return '<span class="packrelay-source-badge mobile">' . esc_html__( 'Mobile App', 'mrdemonwolf' ) . '</span>';
	}
	...
	protected function extra_tablenav( $which ) {
		...
		<div class="alignleft actions">
			<select name="provider_filter">
				<option value=""><?php esc_html_e( 'All Providers', 'mrdemonwolf' ); ?></option>
			...
			<select name="source_filter">
				<option value=""><?php esc_html_e( 'All Sources', 'mrdemonwolf' ); ?></option>
				<option value="mobile_app" <?php selected( $current_source, 'mobile_app' ); ?>><?php esc_html_e( 'Mobile App', 'mrdemonwolf' ); ?></option>
				<option value="divi_frontend" <?php selected( $current_source, 'divi_frontend' ); ?>><?php esc_html_e( 'Divi Frontend', 'mrdemonwolf' ); ?></option>
			</select>
			<?php submit_button( __( 'Filter', 'mrdemonwolf' ), '', 'filter_action', false ); ?>
		</div>
		<?php
	}
	...
	public function no_items() {
		esc_html_e( 'No entries found.', 'mrdemonwolf' );
	}
}
