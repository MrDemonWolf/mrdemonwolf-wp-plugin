...
/**
 * Class MRDW_Forms_Divi_Submissions
 *
...
class MRDW_Forms_Divi_Submissions {
	 ...
	 * Constructor.
	 *
	 * @param MRDW_Forms_Entry_Store|null $entry_store Optional entry store instance for testing.
	 */
	public function __construct( $entry_store = null ) {
		$this->entry_store = $entry_store ? $entry_store : new MRDW_Forms_Entry_Store();
	}
	...
	public function save_submission( $processed_fields, $et_contact_error, $contact_form_info ) {
		...
		$this->entry_store->add(
			array(
				...
				'form_name'   => $form_title ? $form_title : __( 'Contact Form', 'mrdw' ),
				'page_id'     => $page_id,
