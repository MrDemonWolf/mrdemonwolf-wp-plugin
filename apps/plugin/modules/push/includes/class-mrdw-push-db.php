<?php
/**
 * Database operations for MRDW_Push.
 *
 * @package MrDemonWolf
 */
...
class MRDW_Push_DB {
	...
	public static function insert_device( $data ) {
		...
		$table = $wpdb->prefix . 'mrdw_push_devices';
	...
	public static function get_all_active_tokens() {
		...
		$table    = $wpdb->prefix . 'mrdw_push_devices';
		$dev_mode = get_option( 'mrdw_push_dev_mode', '0' );
	...
	public static function get_tokens_by_target( $target_type, $target_ids = null ) {
		...
		$devices_table       = $wpdb->prefix . 'mrdw_push_devices';
		$device_groups_table = $wpdb->prefix . 'mrdw_push_device_groups';
	...
	public static function invalidate_device_cache() {
		delete_transient( 'mrdw_push_device_summary_stats' );
		delete_transient( 'mrdw_push_device_count_platform' );
	}
	...
	public static function invalidate_notification_cache() {
		delete_transient( 'mrdw_push_notification_counts_status' );
		delete_transient( 'mrdw_push_success_rate' );
		delete_transient( 'mrdw_push_monthly_notification_stats' );
	}
	...
	public static function get_device_count_by_platform() {
		$cached = get_transient( 'mrdw_push_device_count_platform' );
		if ( false !== $cached ) {
			return $cached;
		}
		...
		set_transient( 'mrdw_push_device_count_platform', $counts, 5 * MINUTE_IN_SECONDS );
	...
	public static function get_device_summary_stats() {
		$cached = get_transient( 'mrdw_push_device_summary_stats' );
		if ( false !== $cached ) {
			return $cached;
		}
		...
		set_transient( 'mrdw_push_device_summary_stats', $result, 5 * MINUTE_IN_SECONDS );
	...
	public static function create_group( $data ) {
		...
		$table = $wpdb->prefix . 'mrdw_push_groups';
	...
	public static function get_groups_with_counts() {
		...
		$groups_table        = $wpdb->prefix . 'mrdw_push_groups';
		$device_groups_table = $wpdb->prefix . 'mrdw_push_device_groups';
	...
	public static function assign_devices_to_group( $group_id, $device_ids ) {
		...
		$table = $wpdb->prefix . 'mrdw_push_device_groups';
	...
	public static function insert_notification( $data ) {
		...
		$table = $wpdb->prefix . 'mrdw_push_notifications';
		$now   = current_time( 'mysql' );
	...
	public static function get_notification_counts_by_status() {
		$cached = get_transient( 'mrdw_push_notification_counts_status' );
		if ( false !== $cached ) {
			return $cached;
		}
		...
		set_transient( 'mrdw_push_notification_counts_status', $counts, 5 * MINUTE_IN_SECONDS );
	...
	public static function get_success_rate() {
		$cached = get_transient( 'mrdw_push_success_rate' );
		if ( false !== $cached ) {
			return $cached;
		}
		...
		set_transient( 'mrdw_push_success_rate', $rate, 5 * MINUTE_IN_SECONDS );
	...
	public static function insert_notification_history( $post_id, $notification_id ) {
		...
		$table = $wpdb->prefix . 'mrdw_push_notification_history';
	...
	public static function get_post_notification_history( $post_id ) {
		...
		$history_table       = $wpdb->prefix . 'mrdw_push_notification_history';
		$notifications_table = $wpdb->prefix . 'mrdw_push_notifications';
	...
	public static function get_monthly_notification_stats( $months = 12 ) {
		$cache_key = 'mrdw_push_monthly_notification_stats';
